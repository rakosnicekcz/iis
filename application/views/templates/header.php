  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarColor01">
      <ul class="navbar-nav me-auto">
        <li class="nav-item">
          <a class="nav-link" href=<?php echo site_url('contacts/contacts'); ?>>Contacts</a>
        </li>
      </ul>
      <?php if ($this->session->has_userdata('email')): ?>
        ...
        <li class="nav-item dropdown dropleft">
          ...
          <div class="dropdown-menu neco" style="left: -50px">
            <a class="dropdown-item" href=<?php echo site_url('user/user'); ?>>my presentations</a>
            <a class="dropdown-item" href=<?php echo site_url('user/user'); ?>>my conferences</a>
            <a class="dropdown-item" href=<?php echo site_url('user/user'); ?>>my tickets</a>
