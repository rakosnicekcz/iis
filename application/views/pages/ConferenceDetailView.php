...
<html lang="en">
  ...
  <body>
    <a href= <?php echo base_url();?> style="margin-top 90px; margin-left: 10px;">
      <button style="margin-top: 80px; margin-bottom: 10px; margin-left: 10px" type="button" class="btn btn-primary btn-lg"><-- Back to conferences</button>   
    </a>   
    <div class="container">
        <div class="row">
            <div class="col">
              ...
              <div id="myTabContent" class="tab-content">
                <div class="tab-pane fade show active" id="info" style="margin-top: 5%">
                  ...
                  <div style="float:left">
                    <h3>Free slots</h3>
                    <p>XXX/<?php echo $conference["capacity"]?></p>
                  </div>
