          ...
          <div class="card-body p-5 text-center">
            ...
            <div class="mb-md-5 mt-md-4">
              ...
              <div class="form-outline form-white mb-4">
                ...
                <input type="text" class="form-control" id="place" aria-describedby="place" name="place" value="<?php echo set_value('palce', $conference["place"]) ?>">
              ...
              <div class="form-outline form-white mb-4">
                ...
                <input type="number" min="0" class="form-control" id="price" aria-describedby="price" name="price" value="<?php echo set_value('price', $conference["price"]) ?>">
              ...
              <div class="form-outline form-white mb-4">
                ...
                <input class="form-control" id="from" type="datetime-local" name="from" value="<?php echo set_value("from", date('Y-m-d\TH:i', strtotime($conference["from"]))); ?>">
            ...
            <div class="form-outline form-white mb-4">
              ...
              <input class="form-control" type="datetime-local" id="to" type="date" name="to" value="<?php echo set_value("to", date('Y-m-d\TH:i', strtotime($conference["to"]))); ?>">
            ...
            <div class="form-outline form-white mb-4">
              ...
              <input type="number" min="0" class="form-control" id="capacity" aria-describedby="capacity" name="capacity" value="<?php echo set_value('capacity', $conference["capacity"]) ?>">
