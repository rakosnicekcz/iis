          ...
          <div class="card-body p-5 text-center">
            ...
            <div class="mb-md-5 mt-md-4">
              ...
              <div class="form-outline form-white mb-4">
                ...
                <input type="text" class="form-control" id="name" name="name" value="<?php echo $conference["name"] ?>">
              ...
              <div class="form-outline form-white mb-4">
                ...
                <input type="text" class="form-control" id="place" aria-describedby="place" name="place" value="<?php echo $conference["place"] ?>">
              ...
              <div class="form-outline form-white mb-4">
                ...
                <input type="number" min="0" class="form-control" id="price" aria-describedby="price" name="price" value="<?php echo $conference["price"] ?>">
              ...
              <div class="form-outline form-white mb-4">
                ...
                <input class="form-control" id="from" type="datetime-local" name="from" value="<?php echo date('Y-m-d\TH:i', strtotime($conference["from"])); ?>">
            ...
            <div class="form-outline form-white mb-4">
              ...
              <input class="form-control" type="datetime-local" id="to" type="date" name="to" value="<?php echo date('Y-m-d\TH:i', strtotime($conference["to"])); ?>">
            ...
            <div class="form-outline form-white mb-4">
              ...
              <input type="number" min="0" class="form-control" id="capacity" aria-describedby="capacity" name="capacity" value="<?php echo $conference["capacity"] ?>">
